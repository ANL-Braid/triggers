...
CLIENT_NAME = "Globus Triggers Command Line Interface"
AUTH_SCOPES = [
    "openid",
    "email",
    "profile",
...
DEFAULT_TOKEN_FILE = pathlib.Path.home() / pathlib.Path(".globus_triggers_tokens.json")
        ...
        if token_set is not None:
            if token_set.refresh_token is not None:
                ...
                def refresh_handler(
                    ...
                    _ = token_cache.update_from_oauth_token_response(
