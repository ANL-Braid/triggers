...
"""
import logging
from trigger_service.version import VERSION
...
def set_stream_logger(name='trigger', level=logging.DEBUG, format_string=None):
    """Add a stream log handler.
...
logging.getLogger('trigger').addHandler(logging.NullHandler())
